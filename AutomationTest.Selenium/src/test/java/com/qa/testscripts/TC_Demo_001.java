   ...
   //     edriver.close();
    ...
    //    edriver1.close();
		...
		public static void main(String[] args) {
		    ...
		    java.util.List<WebElement> findElements = driver.findElements(By.xpath("//span[@class=\"a-size-medium a-color-base a-text-normal\"]"));
		    
		    System.out.println("total"+findElements.size());
